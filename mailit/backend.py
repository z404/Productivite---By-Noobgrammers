...
def buildemail(emailreturned: dict, service) -> list:
    ...
    for one in headr:
        ...
        if one["name"] == "Subject" or one["name"] == "subject":
            ...
            if msg_subject[0:5].lower() == "pr1: ":
                temp_dict["Priority"] = 1
            elif msg_subject[0:5].lower() == "pr2: ":
                temp_dict["Priority"] = 2
            elif msg_subject[0:5].lower() == "pr3: ":
                temp_dict["Priority"] = 3
            elif msg_subject[0:5].lower() == "pr4: ":
                temp_dict["Priority"] = 4
            elif msg_subject[0:5].lower() == "pr5: ":
                temp_dict["Priority"] = 5
            else:
                temp_dict["Priority"] = 6
        else:
            pass
